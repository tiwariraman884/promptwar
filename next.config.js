    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'X-DNS-Prefetch-Control', value: 'on' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://app.posthog.com https://us-assets.i.posthog.com https://maps.googleapis.com https://cdn.jsdelivr.net https://unpkg.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "font-src 'self' https://fonts.gstatic.com",
              "img-src 'self' data: blob: https: http:",
              `connect-src 'self' https://*.supabase.co https://generativelanguage.googleapis.com https://app.posthog.com https://us.i.posthog.com https://us-assets.i.posthog.com https://maps.googleapis.com https://world.openfoodfacts.org https://cdn.jsdelivr.net https://unpkg.com blob:${process.env.NODE_ENV === 'development' ? ' ws://127.0.0.1:* ws://localhost:* wss://127.0.0.1:* wss://localhost:*' : ''}`,
