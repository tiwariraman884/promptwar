...
export const ECO_PRODUCTS = [
  ...
  {
    id: "compost-bin",
    name: "Home Compost Bin (20L)",
    category: "Garden",
    co2Saved: 28.8,
    price: 1499,
    currency: "₹",
    rating: 4.6,
    badge: "Methane reducer",
    description: "Aerobic composting system for kitchen waste. Diverts organic matter from landfills, preventing methane emissions.",
  },
  {
    ...
    currency: "₹",
    rating: 4.4,
    badge: "Disposable-free",
    description: "Fork, knife, spoon, chopsticks & straw in a cotton pouch. Replaces ~300 disposable utensils/year.",
  },
  {
    id: "solar-power-bank",
    ...
    rating: 4.5,
    badge: "Solar charged",
    description: "Dual USB output with solar panel. Reduces grid charging for phones and tablets. IP65 waterproof.",
  },
  {
    id: "copper-bottle",
    ...
    rating: 4.8,
    badge: "Ayurvedic",
    description: "Traditional copper vessel with health benefits. Eliminates plastic bottle use. Handcrafted by Indian artisans.",
  },
  {
    id: "seed-balls-pack",
    name: "Native Seed Balls Kit (25 pack)",
    category: "Garden",
    co2Saved: 15.0,
    price: 399,
    currency: "₹",
    rating: 4.3,
    badge: "Biodiversity",
    description: "Pre-made clay seed balls with native wildflower and tree seeds. Toss on bare land to grow mini green patches.",
  },
  {
    id: "bicycle-repair-kit",
    name: "Complete Bicycle Repair Kit",
    category: "Transport",
    co2Saved: 52.0,
    price: 1199,
    currency: "₹",
    rating: 4.6,
    badge: "Zero emission",
    description: "Everything needed to keep your bicycle road-ready. Encourages cycling over motorized transport for short trips.",
  },
  {
    id: "jute-shopping-bags",
    name: "Jute Shopping Bags (5 pack)",
    category: "Lifestyle",
    co2Saved: 3.5,
    price: 449,
    currency: "₹",
    rating: 4.5,
    badge: "Handwoven",
    description: "Sturdy jute bags made by rural Indian cooperatives. Replaces over 1,000 plastic carry bags per year.",
  },
  {
    ...
    currency: "₹",
    rating: 4.7,
    badge: "Phantom killer",
    description: "Auto-cuts standby power for connected devices. Timer-based scheduling eliminates phantom loads from TVs, chargers, and appliances.",
  },
  {
    id: "menstrual-cup",
    ...
    rating: 4.8,
    badge: "10-year life",
    description: "Replaces ~2,400 disposable pads/tampons over its lifetime. FDA-approved medical silicone. Saves money and reduces landfill waste.",
  },
  {
    ...
    rating: 4.4,
    badge: "Fair trade",
    description: "GOTS certified organic cotton, azo-free dyes. Made in India with fair wages. 70% less water than conventional cotton tees.",
  },
  {
    id: "terracotta-water-cooler",
    name: "Terracotta Water Cooler (5L)",
    category: "Home",
    co2Saved: 12.0,
    price: 849,
    currency: "₹",
    ...
    description: "Natural clay pot cools water by evaporation — no electricity needed. Traditional Indian design supporting local potters.",
  },
  {
    ...
    rating: 4.5,
    badge: "Auto on/off",
    description: "Waterproof solar-powered pathway lights. Auto-on at dusk. Replaces wired lighting with zero operating cost.",
  },
  {
    id: "ev-charger-portable",
    name: "Portable EV Charger (Type 2)",
    category: "Transport",
    co2Saved: 156.0,
    price: 8999,
    currency: "₹",
    rating: 4.9,
    badge: "Level 2",
    description: "Universal portable EV charger compatible with all Indian electric vehicles. Charge anywhere with a 15A socket. BIS certified.",
  },
  {
    id: "recycled-notebook-set",
    ...
    rating: 4.3,
    badge: "100% recycled",
    description: "Made entirely from post-consumer recycled paper. Chlorine-free processing. Acid-free pages for long-lasting notes.",
  },
];
